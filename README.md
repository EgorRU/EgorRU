...
I use linux/windows, PostgreSQL
...
Бот для хранения файлов, отправленных в тг-чате
...
Бот мониторит выбранные тг-каналы, парсит новые посты в тг-каналах и отправляет в лс
